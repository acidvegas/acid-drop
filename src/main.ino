...
void displayLines() {
    ...
    // Calculate total height needed for all lines instead of calculating extra lines generated by wrapped text
    ...
    // Remove lines from the top if they exceed the screen height - this is an issue with wrapping text still, but only by one or two lines
